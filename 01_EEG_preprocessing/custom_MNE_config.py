...
bids_root = '/media/hcs-psy-narun/Parkinson_project_chch/PD-EEG-ANON_eegOnly/sourcedataRest'                             # where data placed
deriv_root = '/media/hcs-psy-narun/Parkinson_project_chch/PD-EEG-ANON_eegOnly/derivatives/mne_pipeline'                     # where save to
subjects_dir = '/media/hcs-psy-narun/Parkinson_project_chch/PD-EEG-ANON_eegOnly/derivatives/FS_SUBJECT_DIR'    # for freesurfer
